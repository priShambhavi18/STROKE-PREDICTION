...
# Reading Dataset:
dataset = pd.read_csv(r"C:\Users\Asus\Desktop\stroke prediction\healthcare-dataset-stroke-data.csv")
...
# Rename some names in worktype feature for simplicity nothing else:
